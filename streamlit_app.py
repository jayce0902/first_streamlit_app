...
import requests
fruityvice_response = requests.get("https://fruityvice.com/api/fruit/" + fruit_choice) #streamlit.text(fruityvice_response.json()) #removed line as it outputs raw JSON
# take json version of response and NORMALIZE IT
fruityvice_normalized = pandas.json_normalize(fruityvice_response.json())
# Display the output as dataframe
